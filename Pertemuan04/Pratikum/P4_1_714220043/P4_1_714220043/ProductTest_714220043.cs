...
{
    class ProductTest_714220043
    {
        static void Main(string[] args)
        {
            Book_714220043 product1 = new Book_714220043("Book", "C# Object Oriented Solution", "300");
            DVD_714220043 product2 = new DVD_714220043("Ethernal Sunshine Of The Spotless Mind", "145");
